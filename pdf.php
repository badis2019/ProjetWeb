<?php
  //require 'connect.php';
  $objectPdo = new PDO('mysql:host=localhost;dbname=gestionc', 'root', '');
  $pdoStat = $objectPdo->prepare('SELECT * FROM facture ORDER BY numf ASC ');
