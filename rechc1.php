    ...
    <section class="sidebar">
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
       <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Commande</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="suppc1.html"><i class="fa fa-circle-o"></i> Supprimer commande</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>Facture</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
...
<td><button type="submit" name="chercher" value="chercher" class="btn btn-danger">Chercher</button></td>
  </center>
